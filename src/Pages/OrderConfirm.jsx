...
const OrderConfirm = () => {
	...
	const calcTotalPrice = cartAllList.reduce(
		(acc, price) => acc + price.final_total,
		0,
	);
					...
					>
						<div className="container py-5">
							<div className="mx-auto">
								...
								<Link
									to="/cart"
									className="btn btn-text-primary fw-bold mb-3"
								>
								...
								{isOrderDone ? (
									<div className="card p-5 text-center fs-4 mx-5 fw-bold ">
										<i className="bi bi-check-circle-fill text-success ms-2 fs-1"></i>
										<span>訂單完成</span>
										歡迎繼續選購
										<Link
											className="fs-5 mt-2"
												...
												<div className="card-body p-4">
													<div className="row g-3">
														...
														<div className="col-md-6">
															...
															<input
																type="tel"
																className={`form-control ${errors.userTel && "is-invalid"}`}
																id="userTel"
																{...register("userTel", {
																	required: {
																		value: true,
										...
										<div className="col-4">
											<div className="card">
												<div className="card-body">
													...
													<div>
														<button
															className="btn btn-text p-0 pb-2"
															type="button"
														...
														>
															購買明細 <i className="bi bi-caret-down"></i>
														</button>
													</div>
